...
export const calculateStats = (
  ...
  const attack = calculateOtherStat(
    ...
    evs.attack,
    level,
    natureModifier.up === "attack"
      ? 1.1
      : natureModifier.down === "attack"
        ? 0.9
        : 1.0,
  );
  ...
  const defense = calculateOtherStat(
    ...
    evs.defense,
    level,
    natureModifier.up === "defense"
      ? 1.1
      : natureModifier.down === "defense"
        ? 0.9
        : 1.0,
  );
  ...
  const spAttack = calculateOtherStat(
    ...
    evs.spAttack,
    level,
    natureModifier.up === "spAttack"
      ? 1.1
      : natureModifier.down === "spAttack"
        ? 0.9
        : 1.0,
  );
  ...
  const spDefense = calculateOtherStat(
    ...
    evs.spDefense,
    level,
    natureModifier.up === "spDefense"
      ? 1.1
      : natureModifier.down === "spDefense"
        ? 0.9
        : 1.0,
  );
  ...
  const speed = calculateOtherStat(
    ...
    evs.speed,
    level,
    natureModifier.up === "speed"
      ? 1.1
      : natureModifier.down === "speed"
        ? 0.9
        : 1.0,
  );
